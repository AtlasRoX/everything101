...
```mermaid
graph TD
    SubP[The Physical Base] --> A1("Matter: The brain's 86 billion neurons")
    SubP --> A2("Energy: Electrical signals & chemicals")
    
    SubP -->|Generates| SubM[The Mental Software]
    
    SubM --> H1("Your conscious thoughts")

...
```mermaid
graph TD
    Bowl[The Clay Bowl] --> Material["1. Material Cause<br><i>What is it made of?</i><br><b>(Clay)</b>"]
    Bowl --> Formal["2. Formal Cause<br><i>What is its shape/design?</i><br><b>(A hollow bowl shape)</b>"]

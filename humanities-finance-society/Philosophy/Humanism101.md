...
```mermaid
graph TD
    SubA[Authority-Centered Worldview] --> A1("Source of Truth: Divine revelation & Holy texts")
    SubA --> A2("Human Role: Obedience & Submission")
    SubA --> A3("Moral Code: Commandments & Afterlife reward")
    
    SubH[Human-Centered Worldview] --> H1("Source of Truth: Reason, Observation, & Science")

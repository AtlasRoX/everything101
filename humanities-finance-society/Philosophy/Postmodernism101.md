...
```mermaid
graph TD
    Stage1("1. Faithful Copy<br><i>(Reflects basic reality)</i><br>A photograph of a real apple.") --> Stage2("2. Mask/Perversion<br><i>(Distorts reality)</i><br>An airbrushed photo of the apple.")

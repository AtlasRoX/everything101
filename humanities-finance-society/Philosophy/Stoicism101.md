...
```mermaid
graph TD
    Aim[Aiming the Bow] -->|Within your control| Effort[Your Effort & Focus]
    Aim -->|Outside your control| Wind[Wind, Target Moves, Bow Breaks]
...
```mermaid
graph TD
    Event[Crisis / Event] --> Test{Is this event under my direct control?}

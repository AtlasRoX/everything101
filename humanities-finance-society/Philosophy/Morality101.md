...
```mermaid
graph TD
    Level1["<b>Level 1: Pre-Conventional</b><br>(Self-Interest)"] --> Stage1["Stage 1: Avoid Punishment<br><i>'I shouldn't steal because I'll go to jail.'</i>"]
    Level1 --> Stage2["Stage 2: Self-Interest/Reward<br><i>'I should steal because it makes me happy.'</i>"]
    
    Level2["<b>Level 2: Conventional</b><br>(Social Expectations)"] --> Stage3["Stage 3: Good Boy/Nice Girl<br><i>'I should steal so my family thinks I'm a good husband.'</i>"]
    Level2 --> Stage4["Stage 4: Law & Order<br><i>'I shouldn't steal because rules keep society stable.'</i>"]
